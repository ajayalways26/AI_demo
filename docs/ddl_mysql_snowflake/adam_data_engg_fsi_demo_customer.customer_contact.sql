CREATE OR REPLACE TABLE adam_data_engg_fsi_demo.adam_data_engg_fsi_demo_customer.customer_contact (
    ...
    is_primary      NUMBER(3,0)                  COMMENT 'Marks this as the primary contact of this method for the customer',
    contact_status  VARCHAR(255)                 COMMENT 'Lifecycle status of the contact method',
