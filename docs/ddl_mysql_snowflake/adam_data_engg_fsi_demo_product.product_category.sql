CREATE OR REPLACE TABLE adam_data_engg_fsi_demo.adam_data_engg_fsi_demo_product.product_category (
    ...
    product_category_description VARCHAR(65535)     NULL COMMENT 'Category description',
    ...
    CONSTRAINT FK_PRODUCT_CATEGORY_STATUS FOREIGN KEY (status_id)
      REFERENCES adam_data_engg_fsi_demo.adam_data_engg_fsi_demo_product.product_status(product_status_id)
)
