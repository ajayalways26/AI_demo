CREATE OR REPLACE TABLE adam_data_engg_fsi_demo.adam_data_engg_fsi_demo_customer.kyc_document_map (
    ...
    CONSTRAINT FK_kyc_document_map_document_id FOREIGN KEY (document_id) REFERENCES adam_data_engg_fsi_demo.adam_data_engg_fsi_demo_customer.customer_document(document_id),
    CONSTRAINT FK_kyc_document_map_kyc_status_id FOREIGN KEY (kyc_status_id) REFERENCES adam_data_engg_fsi_demo.adam_data_engg_fsi_demo_customer.customer_kyc_status(kyc_status_id)
)
